...
3. Create a new project:
   - Platform: **Next.js**
   - Project name: e.g. `spring-valley-las-vegas-homes` (match your Sentry project slug)
...
3. Name: e.g. `spring-valley-ci-cd`
4. Scopes:
   - ✅ `project:releases`
   - ✅ `project:write`
   - ✅ `org:read`
...
| `SENTRY_PROJECT` | Your project slug from Sentry | Production, Preview |
...
3. Choose channel (e.g., `#site-errors`)
