...
export const businessInfo = {
  ...
  address: {
    streetAddress: "6787 W Tropicana Ave, 2nd Floor",
  ...
  // Geo coordinates — align with office address (officeInfo.coordinates)
  geo: {
...
Office located at 6787 W Tropicana Ave, 2nd Floor, Las Vegas, NV 89103. Available Monday through Friday 9am-6pm, Saturday 10am-4pm, and Sunday by appointment. Call (702) 664-8424 for a free consultation or visit ${siteHostname} to start your Las Vegas real estate journey today.`,
};
...
export const gbpFAQs = [
  ...
  },
  {
    ...
    answer: "Yes! California relocation is a specialty. Dr. Jan helps CA buyers understand Nevada's 0% state income tax advantage, compare home values (40-60% lower than comparable CA properties), and find the perfect Las Vegas neighborhood. Call (702) 664-8424 for California relocation assistance.",
  },
  {
  ...
  },
  {
    ...
    answer: `Call or text (702) 664-8424 for immediate assistance, or email ${agentInfo.email}. Office visits available at 6787 W Tropicana Ave, 2nd Floor, Las Vegas, NV 89103. Monday-Friday 9am-6pm, Saturday 10am-4pm, Sunday by appointment.`,
  },
  {
    question: "Does Dr. Jan help with investment properties in Las Vegas?",
    answer: "Yes! Dr. Jan provides investment property consulting including rental property analysis, cap rate calculations, short-term rental regulations, and multi-family opportunities across the Las Vegas Valley. Contact (702) 664-8424 for investment property guidance.",
  },
];
